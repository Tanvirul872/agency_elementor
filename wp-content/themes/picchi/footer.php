...
?>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery/jquery-3.5.1.min.js"></script>
    ...
    <!-- Plugins js -->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/plugins/plugins.min.js"></script>
